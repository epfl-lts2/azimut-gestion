...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.proxmox_node_name'
        db.add_column(u'servers_server', 'proxmox_node_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.proxmox_node_name'
        db.delete_column(u'servers_server', 'proxmox_node_name')
