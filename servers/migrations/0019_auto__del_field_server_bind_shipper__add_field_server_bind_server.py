...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Server.bind_shipper'
        db.delete_column(u'servers_server', 'bind_shipper')

        # Adding field 'Server.bind_server'
        db.add_column(u'servers_server', 'bind_server',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Server.bind_shipper'
        db.add_column(u'servers_server', 'bind_shipper',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Server.bind_server'
        db.delete_column(u'servers_server', 'bind_server')
