...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.samba_management'
        db.add_column(u'servers_server', 'samba_management',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.samba_management'
        db.delete_column(u'servers_server', 'samba_management')
