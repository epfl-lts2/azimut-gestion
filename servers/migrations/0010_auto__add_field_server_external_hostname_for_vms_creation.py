...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.external_hostname_for_vms_creation'
        db.add_column(u'servers_server', 'external_hostname_for_vms_creation',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.external_hostname_for_vms_creation'
        db.delete_column(u'servers_server', 'external_hostname_for_vms_creation')
