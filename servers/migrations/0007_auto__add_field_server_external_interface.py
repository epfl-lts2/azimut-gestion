...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.external_interface'
        db.add_column(u'servers_server', 'external_interface',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.external_interface'
        db.delete_column(u'servers_server', 'external_interface')
