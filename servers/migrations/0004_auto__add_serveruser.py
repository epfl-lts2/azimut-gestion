...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServerUser'
        db.create_table(u'servers_serveruser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['servers.Server'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'servers', ['ServerUser'])


    def backwards(self, orm):
        # Deleting model 'ServerUser'
        db.delete_table(u'servers_serveruser')
