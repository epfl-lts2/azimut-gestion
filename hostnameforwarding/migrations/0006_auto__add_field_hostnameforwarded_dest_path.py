...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hostnameforwarded.dest_path'
        db.add_column(u'hostnameforwarding_hostnameforwarded', 'dest_path',
                      self.gf('django.db.models.fields.CharField')(default='/', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hostnameforwarded.dest_path'
        db.delete_column(u'hostnameforwarding_hostnameforwarded', 'dest_path')
    ...
    models = {
        ...
        u'hostnameforwarding.hostnameforwarded': {
            ...
            'base_path': ('django.db.models.fields.CharField', [], {'default': "'/'", 'max_length': '255'}),
            ...
            'dest_path': ('django.db.models.fields.CharField', [], {'default': "'/'", 'max_length': '255'}),
