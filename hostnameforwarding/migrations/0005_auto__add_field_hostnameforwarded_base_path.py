...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hostnameforwarded.base_path'
        db.add_column(u'hostnameforwarding_hostnameforwarded', 'base_path',
                      self.gf('django.db.models.fields.CharField')(default='/', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hostnameforwarded.base_path'
        db.delete_column(u'hostnameforwarding_hostnameforwarded', 'base_path')
