...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hostnameforwarded.force_https'
        db.add_column(u'hostnameforwarding_hostnameforwarded', 'force_https',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hostnameforwarded.force_https'
        db.delete_column(u'hostnameforwarding_hostnameforwarded', 'force_https')
