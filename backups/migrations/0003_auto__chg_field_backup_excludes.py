...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Backup.excludes'
        db.alter_column(u'backups_backup', 'excludes', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Backup.excludes'
        raise RuntimeError("Cannot reverse this migration. 'Backup.excludes' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Backup.excludes'
        db.alter_column(u'backups_backup', 'excludes', self.gf('django.db.models.fields.TextField')())
