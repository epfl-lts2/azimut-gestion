...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BackupRun.stdout'
        db.add_column(u'backups_backuprun', 'stdout',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BackupRun.stderr'
        db.add_column(u'backups_backuprun', 'stderr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BackupRun.stdout'
        db.delete_column(u'backups_backuprun', 'stdout')

        # Deleting field 'BackupRun.stderr'
        db.delete_column(u'backups_backuprun', 'stderr')
