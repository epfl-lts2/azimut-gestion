...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.value'
        db.alter_column(u'dnsgestion_entry', 'value', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Entry.value'
        db.alter_column(u'dnsgestion_entry', 'value', self.gf('django.db.models.fields.TextField')())
