...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Zone'
        db.create_table(u'dnsgestion_zone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['servers.Server'])),
            ('name_server', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('contact_email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('default_ttl', self.gf('django.db.models.fields.PositiveIntegerField')(default=3600)),
            ('serial', self.gf('django.db.models.fields.PositiveIntegerField')(default=2014010100)),
            ('refresh', self.gf('django.db.models.fields.PositiveIntegerField')(default=21600)),
            ('retry', self.gf('django.db.models.fields.PositiveIntegerField')(default=900)),
            ('expiry', self.gf('django.db.models.fields.PositiveIntegerField')(default=604800)),
            ('negative_ttl', self.gf('django.db.models.fields.PositiveIntegerField')(default=86400)),
        ))
        db.send_create_signal(u'dnsgestion', ['Zone'])

        # Adding model 'Entry'
        db.create_table(u'dnsgestion_entry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('zone', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dnsgestion.Zone'])),
            ('disabled', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('entry_class', self.gf('django.db.models.fields.CharField')(default='IN', max_length=12)),
            ('entry_type', self.gf('django.db.models.fields.CharField')(default='A', max_length=12)),
            ('value', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'dnsgestion', ['Entry'])


    def backwards(self, orm):
        # Deleting model 'Zone'
        db.delete_table(u'dnsgestion_zone')

        # Deleting model 'Entry'
        db.delete_table(u'dnsgestion_entry')
